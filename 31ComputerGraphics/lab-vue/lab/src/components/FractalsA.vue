...
<script>
  export default {
    ...
    mounted() {
      this.$emit('help', 'З початку доступне меню зліва, що дозволяє змінювати основний колір фракталу та кнопка зберегти зображення. Щоб перемістити центр фракталу настисніть на нього. Щоб приблизити або віддалити фрактал оберіть відповідні кнопки під фракталом');
