...
<script>
  export default {
    ...
    mounted() {
      this.$emit('help', 'Доступне керування побудовою фракталу за допомогою меню зліва: зокрема можливість вибрати колір, густину, відношення маси, довжину сліду, що будуть використані для параметрів генерації фракатлу. Також є можливість збереження зображення.');
      this.render();
    },
  };
</script>
