...
int main(void)
{
  ...
  while (1)
  {
    ...
    char * firstLine = "Kovalenko Dmytro Mykhailovych";
	char * secondLine = "Alternate cyclic switching on of red and blue LEDs";
	lcdSrollingString(0, counter, firstLine);
	lcdSrollingString(1, counter, secondLine);
