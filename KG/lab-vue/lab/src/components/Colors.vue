...
export default {
  ...
  mounted() {
    this.$emit('help', 'Спершу натисніть на кнопку "Завантажити зображення" та оберіть файл, далі буде доступно змінювання насичення зеленого кольору рображення, що буде відображатись у реальному часі. Можливість зберегти модифіковане зображення. При наведенні на зображення буде відображено кординати пікселя у форматі RGB та HSC. Можливо порівнювати два зображення за допомогою перетягування мишкою вертикальної межі.');
  },
  methods: {
    selectFile() {
